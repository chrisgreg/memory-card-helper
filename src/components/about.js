...
export default () => {
  return (
    <div>
      ...
      <p>Calculation based on <a href="http://kb.sandisk.com/app/answers/detail/a_id/69/~/number-of-pictures-that-can-be-stored-on-a-memory-device">Sandisk memory card information</a></p>
